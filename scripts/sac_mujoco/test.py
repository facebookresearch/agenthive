...
from torchrl.envs import TransformedEnv, R3MTransform, SelectTransform
...
env = make_env(task="visual_franka_slide_random-v3", reward_scaling=5.0, device=torch.device('cuda:0'), visual_transform='rrl')
