...
here=$(pwd)
git clone -c submodule.robohive/sims/neuromuscular_sim.update=none --branch add_all_xmls --recursive https://github.com/vikashplus/robohive.git $MJENV_LIB_PATH
cd $MJENV_LIB_PATH
